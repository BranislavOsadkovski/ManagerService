...
public class SessionListener implements HttpSessionListener{
	...
	/**
	 *Gets notified by HttpSessionEvent when the Session is created and logs the change
	 */
	@Override
	...
	/**
	 *Gets notified by HttpSessionEvent when the Session is destroyed and logs the change
	 */
	@Override
